...
@Component({
  ...
  styles: ['.state{text-align:center;padding:var(--space-5) var(--space-4);border:1px dashed var(--color-border-strong);border-radius:var(--radius-lg);background:var(--color-surface)}.symbol{display:grid;place-items:center;width:2.5rem;height:2.5rem;margin:auto;border-radius:50%;background:var(--color-action-soft);color:var(--color-action);font-size:var(--font-size-lg)}h2{margin:var(--space-3) 0 var(--space-1);color:var(--color-navy);font-size:var(--font-size-lg)}p{max-width:32rem;margin:0 auto;color:var(--color-text-muted)}'],
